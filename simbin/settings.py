...
SECRET_KEY = os.environ.get("SECRET_KEY", "insecure-dev-fallback-do-not-use-in-production")
...
ALLOWED_HOSTS = os.environ.get(
    "ALLOWED_HOSTS", "192.168.1.100,simbin.augsentric.com,127.0.0.1,localhost"
).split(",")
...
# WhiteNoise static file serving (Django 5.x STORAGES format)
STORAGES = {
    "staticfiles": {
